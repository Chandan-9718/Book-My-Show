...
import Actorarray from '../AllArray/Actorarray';
...
function MovieDetail(props) {
   ...
   const location = useLocation();
    ...
    const [DisplayActorArray, setDisplayActorArray] = useState(Actorarray);
                ...
                {DisplayActorArray.map((actor, index) => {
                    ...
                    return (<div className="Actor_picAndName">
                        <img className="Actor_pic"
                            src={actor.urll}
                            alt="" />
                        <span className="Actor_name">{actor.firstname} {actor.lastname}</span>
                    </div>);
                })}
